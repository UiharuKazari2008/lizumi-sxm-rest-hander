        ...
        if (err) {
            ...
            try {
                ...
                if (_json['ModuleListResponse']['messages'].length > 0 && _json['ModuleListResponse']['messages'][0]['message'].toLowerCase() === 'successful') {
                    // Is Episode Airing
                    /*const e = _json['ModuleListResponse']['moduleList']['modules'][0]['moduleResponse']['liveChannelData']['markerLists'].filter(e => e['layer'] === 'episode' && !e['episode']['show']['isPlaceholderShow'])[0]['markers']
                    if (episodes > 0) {
                        ...
                        const item = {
                            ...
                            title: e['episode']['shortDescription'],
